...
function Skills() {
  return (
    <section className="container mx-auto flex flex-col items-center justify-between w-full min-h-screen pr-5">
      <motion.h1
      ...
      <div className="grid grid-cols-3 relative w-full gap-4">
        <div className="grid grid-rows-2">
          <div className="relative flex max-h-[400px] min-h-[400px] w-full max-w-[32rem] flex-col overflow-hidden rounded-lg   p-6 ">
            <AnimatedList>
