...
import avatar from "@/assets/image2.png"
...
const Circle = forwardRef(({ className, children, color = "#fff", link }, ref) => {
  return (
    <a
      ref={ref}
      className={cn(
        "z-10 flex size-12 cursor-pointer items-center justify-center rounded-full bg-[#0B0B0B]/60 border border-border/30 p-1 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] hover:scale-110 duration-150",
        className,
      )}
      style={{
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[300px] w-full items-center justify-center o p-10"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref} color="#47dc5a" link="https://wa.me/201153782020">
          <img src={whatsapp} />
          </Circle>
          <Circle ref={div5Ref} color="#81cde9" link="https://www.linkedin.com/in/ahmed-abo-raya/" >
          <img src={linkedin} />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref} color="#01a9da" link="https://www.facebook.com/profile.php?id=100016644704372" >
          <img src={facebook} />
          </Circle>
          <Circle ref={div4Ref} className="size-16 md:size-22" color="#d89077" link="https://drive.google.com/file/d/10chKtLGvdTuDe3nwKDo2Xs4z-KiubDh2/view?usp=drive_link">
            <img src={avatar} />
          </Circle>
          <Circle ref={div6Ref} color="#8b53de" link="https://github.com/AhmedAboRaya">
          <img src={github} className="p-[2px]" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref} color="#df36ac" link="https://www.instagram.com/abo_raya1212/" >
          <img src={instagram} />
          </Circle>
          <Circle ref={div7Ref} link="https://x.com/AhmedMa27931006/" >
          <img src={x} />
          </Circle>
        </div>
      </div>
      ...
      <AnimatedBeam
        ...
        curvature={-75}
        endYOffset={-10}
        gradientStartColor = "#34aa39"
        gradientStopColor = "#47dc5a"
        pathColor="#fff"
      />
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={div2Ref}
        toRef={div4Ref}
        gradientStartColor = "#015596"
        gradientStopColor = "#01a9da"
        pathColor="#fff"
      />
      <AnimatedBeam
        containerRef={containerRef}
        ...
        curvature={75}
        endYOffset={10}
        gradientStartColor = "#9779e0"
        gradientStopColor = "#df36ac"
        pathColor="#fff"
      />
      <AnimatedBeam
        containerRef={containerRef}
      ...
      <AnimatedBeam
        ...
        toRef={div4Ref}
        reverse
        gradientStartColor = "#5a3a8f"
        gradientStopColor = "#8b53de"
        pathColor="#fff"
      />
      <AnimatedBeam
        containerRef={containerRef}
